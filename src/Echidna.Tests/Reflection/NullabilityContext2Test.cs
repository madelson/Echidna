...
namespace System.Reflection.Tests
{
    ...
    {
        public MemberDataAttribute(string name) : base(name) { }
    }

    internal class FactAttribute : TestAttribute { }

    internal class SkipOnMonoAttribute : Attribute { public SkipOnMonoAttribute(string justification) { } }

    internal static class Assert
    {
        public static void Equal<T>(T expected, T actual) => NUnit.Framework.Assert.AreEqual(expected, actual);
        public static void Empty(IEnumerable collection) => NUnit.Framework.Assert.IsEmpty(collection);
        public static void NotEmpty(IEnumerable collection) => NUnit.Framework.Assert.IsNotEmpty(collection);
